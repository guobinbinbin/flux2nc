...
def flux2nc(influxes,outpath,var=None, camada=None, start_year=None,end_year=None):
    ...
    try:
        ...
        # 过滤掉snow文件
        file_list = [f for f in file_list if f.startswith('fluxes')]
        # remove snow files
    ...
    #     var_name = "Snow Water Equivalent"
        ...
        var_txt = "wdew"
        var_name = "Canopy interception of liquid water"
    else:
...
if __name__ == "__main__":
    ...
    flux2nc(
        influxes=r'D:\PROJECTS\Xiangjiang_VIC\TEST\input\vic_output/',
        outpath=r'D:\PROJECTS\Xiangjiang_VIC\TEST\1/',
        var=1,
        camada=3,
        start_year=2001,
        end_year=2020
